...
namespace Common
{
    public class PublicMethod
    {
        ...
        public static int GetRecordCount(string tablename)
        {
            ...
            return Convert.ToInt32(MysqlEasy.ExecuteScalar(s));
        }
        ...
        public static DataTable GetDataTable(string tablename, string where)
        {
            ...
            return MysqlEasy.ExecuteDataTable(s);
        }
        ...
        public static DataRow GetADataRow(string tableName, string keyName, string value, out string msg)
        {
            try
            {
                ...
                MySqlParameter[] sp ={new MySqlParameter("@table",tableName),
                    new MySqlParameter("@keyname",keyName),
                    new MySqlParameter("@value",value)
                };

                DataTable dt =MysqlEasy.ExecuteDataTable(s,sp);
        ...
        public static int GetMaxID(string tableName, string field)
        {
            ...
            MySqlParameter[] para = { new MySqlParameter("@field",field),new MySqlParameter("@tablename",tableName)};
            object obj = MysqlEasy.ExecuteScalar(s,para);
