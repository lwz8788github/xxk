...
{
    public partial class RemoveStepFrm : DevExpress.DXCore.Controls.XtraEditors.XtraForm
    {
        ...
        public RemoveStepFrm(DataTable _datain, DataTable _dataselect)
        {
            InitializeComponent();
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            dataout = pralgthHelper.RemoveStepJump(datain, dataselect, DataProcessMethod.RemoveStep, lr, out dataoutsel);
